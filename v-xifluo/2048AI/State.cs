...
namespace _2048AI
{
    public class State
    {
            ...
            get
            {
                ...
                foreach (var element in Elements.Reverse())
                {
                    if (element == 0)
                    {
                        ...
                        {
                            Place2 = new State(this.board | tile),
                            Place4 = new State(this.board | (tile << 1))
                        };
                    }
        ...
        public State MakeMove(Moves move)
        {
            ulong newBoard;
            switch (move)
            {
        ...
        {
            return new State(TransposeBoard(this.board));
        }
    ...
    public class RandomChoice
    {
        ...
        /// </summary>
        public State Place2 { get; set; }

        /// <summary>
        /// GameState after placing a random 4
        /// </summary>
        public State Place4 { get; set; }
    }
}